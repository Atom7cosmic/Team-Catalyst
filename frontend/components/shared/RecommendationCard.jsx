...
export default function RecommendationCard({ recommendation, showActions = true, onUpdate }) {
  ...
  const statusConfigItem = statusConfig[recommendation.status];
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-3 flex items-center gap-4 text-sm">
            ...
            <div>
              ...
              <span className={cn(
                'font-semibold',
                riskPercentage > 60 ? 'text-red-400' : riskPercentage > 40 ? 'text-yellow-400' : 'text-green-400'
              )}>
                {riskPercentage}%
              </span>
            </div>
          ...
          {showActions && recommendation.status === 'pending' && (
            <div className="mt-4 flex gap-2">
              ...
              <Button
                size="sm"
                variant="ghost"
                onClick={() => router.push(`/recommendations/${recommendation._id}`)}
